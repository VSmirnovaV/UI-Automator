...
import androidx.test.uiautomator.Until.textEquals
...
//    }
    ...
    fun testEmptyField() {
        ...
        device.findObject(By.res(packageName, "userInput")).text = emptyFieldSet
        device.findObject(By.res(packageName, "buttonChange")).click()

        textEquals(device.findObject(By.res(packageName, "textToBeChanged")).text)

    }

    @Test
    fun openingTextInNewActivity() {
        val packageName = MODEL_PACKAGE
        waitForPackage(packageName)
